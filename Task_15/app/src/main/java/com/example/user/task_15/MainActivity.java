...
import com.example.user.task_15.listings.Datum;
...
public class MainActivity extends AppCompatActivity {
   ...
   */
    ...
    private void updateLogoList() {
        ...
        compositeDisposable.add(apiInterface.getCryptocurrencyInfo(csv).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribeWith(new DisposableSingleObserver<Info>(){
            @Override
            ...
            @Override
            public void onError(Throwable e) {
                Toast.makeText(MainActivity.this, "getCryptocurrencyInfo onFailure", Toast.LENGTH_LONG).show();
                Log.d("XXXX",e.getLocalizedMessage());
            }
        }));
    }
